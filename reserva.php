        ...
        <?php if ($msg): ?>
          <div class="alert alert-success alert-custom">
            ...
            <div style="margin-top: 15px;">
              <a href="reservacion.php?id=<?= $cancha['id_cancha'] ?? '' ?>&fecha=<?= $fecha ?>"
                class="btn neumorphic-btn">Ver Calendario</a>
            </div>
          </div>
        <?php elseif ($error): ?>
            ...
            <div class="ocupacion-actual">
                  ...
                  <?php if (!empty($r['foto'])): ?>
                    <a href="perfil_otro.php?id=<?= $r['id_usuario'] ?>">
                      <img src="uploads/usuarios/<?= htmlspecialchars($r['foto']) ?>"
                        alt="<?= htmlspecialchars($r['nombre']) ?>" class="rounded-circle me-3" width="50" height="50"
              ...
              <?php if ($espacios_ocupados_actual > 0 && $reservas_existentes): ?>
                ...
                if ($cat_horario && $cat_horario != $usuario_data['categoria']): ?>
                  <div
                    style="background: #dc3545; color: white; padding: 10px; border-radius: 8px; margin-top: 10px; font-size: 14px;">
                ...
                <?php elseif ($cat_horario): ?>
                  <div
                    style="background: #28a745; color: white; padding: 10px; border-radius: 8px; margin-top: 10px; font-size: 14px;">
              ...
              <form action="" method="POST" id="reservaForm">
                ...
                <div class="mb-4">
                  ...
                  <input type="text" name="nombre" class="form-control neumorphic-input" required id="nombre"
                    placeholder="Nombre completo" value="<?= htmlspecialchars($usuario_data['nombre'] ?? '') ?>">
                </div>
                ...
                <div class="mb-4">
                  ...
                  <input type="tel" name="telefono" class="form-control neumorphic-input" required id="telefono"
                    placeholder="Ej: +54 9 11 1234-5678" value="<?= htmlspecialchars($usuario_data['telefono'] ?? '') ?>">
                </div>
                ...
                <div class="mb-4">
                  ...
                  <textarea name="observaciones" class="form-control neumorphic-textarea" id="observaciones"
