      ...
      <div class="neumorphic-card">
        ...
        <form action="" method="POST" id="registroForm">
          ...
          <div class="mb-4">
            ...
            <input type="text" name="telefono" class="form-control neumorphic-input" id="telefono"
        ...
        Está muy feo, si podés hacerlo lindo :) -->
          <div class="mb-4">
            <label for="categoria" class="form-label">Categoría *
              ...
              <button type="button" class="btn-sm btn-outline-info rounded-circle" data-bs-toggle="popover"
          ...
          <div class="mb-4">
            ...
            <input type="password" name="contraseña" class="form-control neumorphic-input" required id="contraseña"
          ...
          <div class="mb-4">
            ...
            <input type="password" name="repetir_contraseña" class="form-control neumorphic-input" required
              id="repetir_contraseña" placeholder="Repita su contraseña">
